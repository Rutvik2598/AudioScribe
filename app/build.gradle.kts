...
android {
    namespace = "com.example.audioscribe"
    compileSdk {
        version = release(36) {
            minorApiLevel = 1
        }
    ...
    defaultConfig {
        applicationId = "com.example.audioscribe"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.room:room-ktx:2.8.4") // Coroutines support for Room
    ...
    // OkHttp (used by Retrofit for Gemini REST calls)
